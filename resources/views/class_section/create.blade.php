        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Class Section Form</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" method="POST" action="/ClassSectionsStore" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="section_id[]" class="form-control" multiple>
                                        @foreach ($sections as $section)
                                            <option value="{{ $section->id }}"
                                                {{ in_array($section->id, old('section_id', [])) ? 'selected' : '' }}>
                                    ...
                                    @if ($errors->has('section_id.*'))
                                        @foreach ($errors->get('section_id.*') as $messages)
