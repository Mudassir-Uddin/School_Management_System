                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Classes <span>| {{ $label }}</span></h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>{{ $classesFiltered }}</h6>
                                            <span class="pt-1 text-success small fw-bold">Total</span>
                                        </div>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Teachers <span>| {{ $label }}</span></h5>
                        ...
                        <div class="col-xxl-4 col-xl-12">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Students <span>| {{ $label }}</span></h5>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Subjects <span>| {{ $label }}</span></h5>
                        ...
                        <div class="col-12">
                            <div class="overflow-auto card recent-sales">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Recent Students <span>| {{ $label }}</span></h5>
